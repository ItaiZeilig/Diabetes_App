...
class ChatScreen extends StatefulWidget {
  ...
  ChatScreen({this.peerId, this.peerAvatar});


  @override
  State createState() => _ChatScreenState(peerId: peerId, peerAvatar: peerAvatar);
}

class _ChatScreenState extends State<ChatScreen> {

_ChatScreenState({this.peerId, this.peerAvatar});
  ...
  Widget buildListMessage() {
    return Flexible(
      child: groupChatId == ''
          ? Center(child: CircularProgressIndicator(valueColor: AlwaysStoppedAnimation<Color>(Color(0xfff5a623))))
          : StreamBuilder(
